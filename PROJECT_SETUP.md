...
3. Name the project exactly **`clinic-2026-sample-dashboard`**.
...
```
https://clinic-2026-sample-dashboard.pages.dev
```
...
1. Export a parquet file from your pipeline using `export_dataset(df, "name")` in `src/utils/dashboard_export.py` (project root, not `dashboard/src/`).
